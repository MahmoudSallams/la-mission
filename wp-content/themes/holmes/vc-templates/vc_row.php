...
$mkdf_row_wrapper_start = $mkdf_row_wrapper_end = $row_background_text = $row_background_text_1 = $row_background_text_2 = $row_background_text_size = $row_background_text_color = $row_background_text_size_1440 = $row_background_text_size_1280 = '';
...
if ( ! empty( $row_background_text_1 ) ) {
	...
	$row_background_text = '<div class="mkdf-row-background-text-holder">';
	$row_background_text .= '<div class="mkdf-row-background-text-wrapper ' . esc_attr( $row_background_text_wrapper_classes ) . '">';
	$row_background_text .= '<div class="mkdf-row-background-text-wrapper-inner" ' . holmes_mkdf_get_inline_style( $row_background_text_styles ) . ' ' . esc_html( $row_background_text_datas ) . '>';
...
if ( $row_content_width === 'grid' ) {
	$mkdf_row_wrapper_start .= '<div class="mkdf-row-grid-section-wrapper ' . esc_attr( $grid_row_classes ) . '" ' . esc_attr( $grid_row_datas ) . ' ' . holmes_mkdf_get_inline_style( $mkdf_grid_row_styles ) . '><div class="mkdf-row-grid-section">';
...
$output .= '<div ' . implode( ' ', $wrapper_attributes ) . ' ' . holmes_mkdf_get_inline_style( $mkdf_vc_row_styles ) . '>';
...
print holmes_mkdf_get_clean_output( $output );
