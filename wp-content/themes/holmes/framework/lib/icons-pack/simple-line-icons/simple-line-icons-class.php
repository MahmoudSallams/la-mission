...
if ( ! function_exists( 'holmes_mkdf_add_simple_line_icon_pack' ) ) {
	function holmes_mkdf_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new HolmesMkdfSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'holmes_mkdf_add_icon_pack_into_collection', 'holmes_mkdf_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'holmes_mkdf_add_simple_line_icon_pack_option' ) ) {
	function holmes_mkdf_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'holmes' );
		
		return $options;
	}
	
	add_filter( 'holmes_mkdf_add_icon_pack_into_options', 'holmes_mkdf_add_simple_line_icon_pack_option' );
	add_filter( 'holmes_mkdf_add_icon_pack_into_social_options', 'holmes_mkdf_add_simple_line_icon_pack_option' );
}

class HolmesMkdfSimpleLineIcons implements iHolmesMkdfIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'holmes'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'holmes'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'holmes'),
            'icon-social-facebook'    => esc_html__('Facebook', 'holmes'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'holmes'),
            'icon-social-github'      => esc_html__('Github', 'holmes'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'holmes'),
            'icon-social-instagram'   => esc_html__('Instagram', 'holmes'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'holmes'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'holmes'),
            'icon-social-reddit'      => esc_html__('Reddit', 'holmes'),
            'icon-social-skype'       => esc_html__('Skype', 'holmes'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'holmes'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'holmes'),
            'icon-social-spotify'     => esc_html__('Spotify', 'holmes'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'holmes'),
            'icon-social-twitter'     => esc_html__('Twitter', 'holmes'),
            'icon-social-youtube'     => esc_html__('Youtube', 'holmes')
        );
    }
