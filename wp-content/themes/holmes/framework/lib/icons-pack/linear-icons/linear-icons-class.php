...
if ( ! function_exists( 'holmes_mkdf_add_linear_icon_pack' ) ) {
	function holmes_mkdf_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new HolmesMkdfLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'holmes_mkdf_add_icon_pack_into_collection', 'holmes_mkdf_add_linear_icon_pack' );
}

if ( ! function_exists( 'holmes_mkdf_add_linear_icon_pack_option' ) ) {
	function holmes_mkdf_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'holmes' );
		
		return $options;
	}
	
	add_filter( 'holmes_mkdf_add_icon_pack_into_options', 'holmes_mkdf_add_linear_icon_pack_option' );
}

class HolmesMkdfLinearIcons implements iHolmesMkdfIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
