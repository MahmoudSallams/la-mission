...
if ( ! function_exists( 'holmes_mkdf_add_linea_icon_pack' ) ) {
	function holmes_mkdf_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new HolmesMkdfLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'holmes_mkdf_add_icon_pack_into_collection', 'holmes_mkdf_add_linea_icon_pack' );
}

if ( ! function_exists( 'holmes_mkdf_add_linea_icon_pack_option' ) ) {
	function holmes_mkdf_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'holmes' );
		
		return $options;
	}
	
	add_filter( 'holmes_mkdf_add_icon_pack_into_options', 'holmes_mkdf_add_linea_icon_pack_option' );
}

class HolmesMkdfLineaIcons implements iHolmesMkdfIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
