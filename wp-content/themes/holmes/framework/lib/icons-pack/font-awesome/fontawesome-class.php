...
if ( ! function_exists( 'holmes_mkdf_add_font_awesome_icon_pack' ) ) {
	function holmes_mkdf_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new HolmesMkdfIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'holmes_mkdf_add_icon_pack_into_collection', 'holmes_mkdf_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'holmes_mkdf_add_font_awesome_icon_pack_option' ) ) {
	function holmes_mkdf_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'holmes' );
		
		return $options;
	}
	
	add_filter( 'holmes_mkdf_add_icon_pack_into_options', 'holmes_mkdf_add_font_awesome_icon_pack_option' );
	add_filter( 'holmes_mkdf_add_icon_pack_into_social_options', 'holmes_mkdf_add_font_awesome_icon_pack_option' );
}

class HolmesMkdfIconsFontAwesome implements iHolmesMkdfIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
