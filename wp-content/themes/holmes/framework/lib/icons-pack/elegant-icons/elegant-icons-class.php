...
if ( ! function_exists( 'holmes_mkdf_add_font_elegant_icon_pack' ) ) {
	function holmes_mkdf_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new HolmesMkdfIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'holmes_mkdf_add_icon_pack_into_collection', 'holmes_mkdf_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'holmes_mkdf_add_font_elegant_icon_pack_option' ) ) {
	function holmes_mkdf_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'holmes' );
		
		return $options;
	}
	
	add_filter( 'holmes_mkdf_add_icon_pack_into_options', 'holmes_mkdf_add_font_elegant_icon_pack_option' );
	add_filter( 'holmes_mkdf_add_icon_pack_into_social_options', 'holmes_mkdf_add_font_elegant_icon_pack_option' );
}

class HolmesMkdfIconsFontElegant implements iHolmesMkdfIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
