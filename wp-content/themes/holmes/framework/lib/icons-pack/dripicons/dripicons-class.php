...
if ( ! function_exists( 'holmes_mkdf_add_dripicons_icon_pack' ) ) {
	function holmes_mkdf_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new HolmesMkdfDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'holmes_mkdf_add_icon_pack_into_collection', 'holmes_mkdf_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'holmes_mkdf_add_dripicons_icon_pack_option' ) ) {
	function holmes_mkdf_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'holmes' );
		
		return $options;
	}
	
	add_filter( 'holmes_mkdf_add_icon_pack_into_options', 'holmes_mkdf_add_dripicons_icon_pack_option' );
}

class HolmesMkdfDripicons implements iHolmesMkdfIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
