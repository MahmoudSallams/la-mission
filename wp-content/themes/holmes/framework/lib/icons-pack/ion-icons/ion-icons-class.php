...
if ( ! function_exists( 'holmes_mkdf_add_ion_icon_pack' ) ) {
	function holmes_mkdf_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new HolmesMkdfIonIcons( 'Ion Icons', 'ion_icon' );

		return $iconCollections;
	}

	add_filter( 'holmes_mkdf_add_icon_pack_into_collection', 'holmes_mkdf_add_ion_icon_pack' );
}

if ( ! function_exists( 'holmes_mkdf_add_ion_icon_pack_option' ) ) {
	function holmes_mkdf_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'holmes' );

		return $options;
	}

	add_filter( 'holmes_mkdf_add_icon_pack_into_options', 'holmes_mkdf_add_ion_icon_pack_option' );
	add_filter( 'holmes_mkdf_add_icon_pack_into_social_options', 'holmes_mkdf_add_ion_icon_pack_option' );
}

class HolmesMkdfIonIcons implements iHolmesMkdfIconCollection {
	public $icons;
	public $socialIcons;
	public $title;
	public $param;
