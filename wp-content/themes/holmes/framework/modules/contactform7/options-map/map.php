...
if ( ! function_exists('holmes_mkdf_contact_form_7_options_map') ) {

	function holmes_mkdf_contact_form_7_options_map() {
		
		holmes_mkdf_add_admin_page(
			array(
				'slug'  => '_contact_form7_page',
				'title' => esc_html__( 'Contact Form 7', 'holmes' ),
				'icon'  => 'fa fa-envelope-o'
			)
		);
		
		$panel_contact_form_style_1 = holmes_mkdf_add_admin_panel(
			array(
				'page'  => '_contact_form7_page',
				'name'  => 'panel_contact_form_style_1',
				'title' => esc_html__( 'Custom Style 1', 'holmes' )
			)
		);
		
		//Text Typography
		
		$typography_text_group = holmes_mkdf_add_admin_group(
			array(
				'name'        => 'typography_text_group',
				'title'       => esc_html__( 'Form Text Typography', 'holmes' ),
				'description' => esc_html__( 'Setup typography for form elements text', 'holmes' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_text_row1 = holmes_mkdf_add_admin_row(
			array(
		...
		holmes_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Text Color', 'holmes' ),
			)
		);
		...
		$typography_text_row2 = holmes_mkdf_add_admin_row(
			array(
		...
		$typography_text_row3 = holmes_mkdf_add_admin_row(
			array(
		...
		$typography_label_group = holmes_mkdf_add_admin_group(
			array(
				'name'        => 'typography_label_group',
				'title'       => esc_html__( 'Form Label Typography', 'holmes' ),
				'description' => esc_html__( 'Setup typography for form elements label', 'holmes' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_label_row1 = holmes_mkdf_add_admin_row(
			array(
		...
		$typography_label_row2 = holmes_mkdf_add_admin_row(
			array(
		...
		$background_border_group = holmes_mkdf_add_admin_group(
			array(
				'name'        => 'background_border_group',
				'title'       => esc_html__( 'Form Elements Background and Border', 'holmes' ),
				'description' => esc_html__( 'Setup form elements background and border style', 'holmes' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$background_border_row1 = holmes_mkdf_add_admin_row(
			array(
		...
		holmes_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Color', 'holmes' )
			)
		);
		...
		holmes_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Transparency', 'holmes' )
			)
		);
		
		$background_border_row2 = holmes_mkdf_add_admin_row(
			array(
		...
		holmes_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Transparency', 'holmes' ),
			)
		);
		...
		holmes_mkdf_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Focus Border Color', 'holmes' )
			)
		);
		...
		holmes_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Border Transparency', 'holmes' )
			)
		);
		
		$background_border_row3 = holmes_mkdf_add_admin_row(
			array(
		...
		holmes_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Width', 'holmes' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		holmes_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Radius', 'holmes' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$padding_group = holmes_mkdf_add_admin_group(
			array(
				'name'        => 'padding_group',
				'title'       => esc_html__( 'Elements Padding', 'holmes' ),
				'description' => 'Setup form elements padding',
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$padding_row = holmes_mkdf_add_admin_row(
			array(
				'name'   => 'padding_row',
		...
		holmes_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Top', 'holmes' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		holmes_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Right', 'holmes' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		holmes_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Bottom', 'holmes' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		holmes_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left', 'holmes' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$margin_group = holmes_mkdf_add_admin_group(
			array(
				'name'        => 'margin_group',
				'title'       => esc_html__( 'Elements Margin', 'holmes' ),
				'description' => esc_html__( 'Setup form elements margin', 'holmes' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$margin_row = holmes_mkdf_add_admin_row(
			array(
				'name'   => 'margin_row',
				'parent' => $margin_group
			)
		...
		holmes_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Top', 'holmes' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		holmes_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Bottom', 'holmes' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		holmes_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Textarea Height', 'holmes' ),
				'description'   => esc_html__( 'Enter height for textarea form element', 'holmes' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$button_typography_group = holmes_mkdf_add_admin_group(
			array(
				'name'        => 'button_typography_group',
				'title'       => esc_html__( 'Button Typography', 'holmes' ),
				'description' => esc_html__( 'Setup button text typography', 'holmes' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_typography_row1 = holmes_mkdf_add_admin_row(
			array(
		...
		$button_typography_row2 = holmes_mkdf_add_admin_row(
			array(
		...
		$button_background_border_group = holmes_mkdf_add_admin_group(
			array(
				'name'        => 'button_background_border_group',
				'title'       => esc_html__( 'Button Background and Border', 'holmes' ),
				'description' => esc_html__( 'Setup button background and border style', 'holmes' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_background_border_row1 = holmes_mkdf_add_admin_row(
			array(
		...
		holmes_mkdf_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Background Hover Color', 'holmes' )
			)
		);
		...
		holmes_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Background Hover Transparency', 'holmes' )
			)
		);
		
		$button_background_border_row2 = holmes_mkdf_add_admin_row(
			array(
		...
		holmes_mkdf_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Border Hover Color', 'holmes' )
			)
		);
		...
		holmes_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Hover Transparency', 'holmes' )
			)
		);
		
		$button_background_border_row3 = holmes_mkdf_add_admin_row(
			array(
		...
		holmes_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Height', 'holmes' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		holmes_mkdf_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Left/Right Padding', 'holmes' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$panel_contact_form_style_2 = holmes_mkdf_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'holmes')
		));

		//Text Typography

		$typography_text_group = holmes_mkdf_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'holmes'),
			'description'	=> esc_html__('Setup typography for form elements text', 'holmes'),
		...
		$typography_text_row1 = holmes_mkdf_add_admin_row(array(
			'name'		=> 'typography_text_row1',
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row2 = holmes_mkdf_add_admin_row(array(
			'name'		=> 'typography_text_row2',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row3 = holmes_mkdf_add_admin_row(array(
			'name'		=> 'typography_text_row3',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_label_group = holmes_mkdf_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'holmes'),
			'description'	=> esc_html__('Setup typography for form elements label', 'holmes'),
			'parent'		=> $panel_contact_form_style_2
		...
		$typography_label_row1 = holmes_mkdf_add_admin_row(array(
			'name'		=> 'typography_label_row1',
			'parent'	=> $typography_label_group
		));
		...
		$typography_label_row2 = holmes_mkdf_add_admin_row(array(
			'name'		=> 'typography_label_row2',
			'next'		=> true,
			'parent'	=> $typography_label_group
		));
		...
		$background_border_group = holmes_mkdf_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'holmes'),
			'description'	=> esc_html__('Setup form elements background and border style', 'holmes'),
			'parent'		=> $panel_contact_form_style_2
		...
		$background_border_row1 = holmes_mkdf_add_admin_row(array(
			'name'		=> 'background_border_row1',
			'parent'	=> $background_border_group
		));
		...
		$background_border_row2 = holmes_mkdf_add_admin_row(array(
			'name'		=> 'background_border_row2',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$background_border_row3 = holmes_mkdf_add_admin_row(array(
			'name'		=> 'background_border_row3',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$padding_group = holmes_mkdf_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'holmes'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_2
		...
		$padding_row = holmes_mkdf_add_admin_row(array(
			'name'		=> 'padding_row',
			'parent'	=> $padding_group
		));
		...
		$margin_group = holmes_mkdf_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'holmes'),
			'description'	=> esc_html__('Setup form elements margin', 'holmes'),
			'parent'		=> $panel_contact_form_style_2
		...
		$margin_row = holmes_mkdf_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = holmes_mkdf_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'holmes'),
			'description'	=> esc_html__('Setup button text typography', 'holmes'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_typography_row1 = holmes_mkdf_add_admin_row(array(
			'name'		=> 'button_typography_row1',
			'parent'	=> $button_typography_group
		));
		...
		$button_typography_row2 = holmes_mkdf_add_admin_row(array(
			'name'		=> 'button_typography_row2',
			'next'		=> true,
			'parent'	=> $button_typography_group
		));
		...
		$button_background_border_group = holmes_mkdf_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'holmes'),
			'description'	=> esc_html__('Setup button background and border style', 'holmes'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_background_border_row1 = holmes_mkdf_add_admin_row(array(
			'name'		=> 'button_background_border_row1',
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row2 = holmes_mkdf_add_admin_row(array(
			'name'		=> 'button_background_border_row2',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row3 = holmes_mkdf_add_admin_row(array(
			'name'		=> 'button_background_border_row3',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
        ...
        $panel_contact_form_style_3 = holmes_mkdf_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'holmes')
        ));
        ...
        $typography_label_row3 = holmes_mkdf_add_admin_row(array(
        ...
        $button_typography_row3 = holmes_mkdf_add_admin_row(array(
	...
	add_action( 'holmes_mkdf_options_map', 'holmes_mkdf_contact_form_7_options_map', holmes_mkdf_set_options_map_position( 'contact_form_7' ) );
}