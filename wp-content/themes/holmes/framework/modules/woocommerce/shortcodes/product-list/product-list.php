...
namespace HolmesCore\CPT\Shortcodes\ProductList;
...
class ProductList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Product List', 'holmes' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						//	'value'       => array(
						//		esc_html__( 'Standard', 'holmes' ) => 'standard',
						...
						//	'heading'     => esc_html__( 'Product Info Position', 'holmes' ),
						//	'value'       => array(
						//		esc_html__( 'Info On Image Hover', 'holmes' ) => 'info-on-image',
						//		esc_html__( 'Info Below Image', 'holmes' )    => 'info-below-image'
						//	),
						//	'save_always' => true
						//),
						array(
							...
							'heading'    => esc_html__( 'Number of Products', 'holmes' )
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'value'       => array_flip( holmes_mkdf_get_query_order_by_array( false, array( 'on-sale' => esc_html__( 'On Sale', 'holmes' ) ) ) ),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Choose Sorting Taxonomy', 'holmes' ),
							'value'       => array(
								esc_html__( 'Category', 'holmes' ) => 'category',
								esc_html__( 'Tag', 'holmes' )      => 'tag',
								esc_html__( 'Id', 'holmes' )       => 'id'
							),
							'save_always' => true,
							'description' => esc_html__( 'If you would like to display only certain products, this is where you can select the criteria by which you would like to choose which products to display', 'holmes' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'taxonomy_values',
							'heading'     => esc_html__( 'Enter Taxonomy Values', 'holmes' ),
							'description' => esc_html__( 'Separate values (category slugs, tags, or post IDs) with a comma', 'holmes' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'image_size',
							'heading'     => esc_html__( 'Image Proportions', 'holmes' ),
							'value'       => array(
								esc_html__( 'Default', 'holmes' )        => '',
								esc_html__( 'Original', 'holmes' )       => 'full',
								esc_html__( 'Square', 'holmes' )         => 'square',
								esc_html__( 'Landscape', 'holmes' )      => 'landscape',
								esc_html__( 'Portrait', 'holmes' )       => 'portrait',
								esc_html__( 'Medium', 'holmes' )         => 'medium',
								esc_html__( 'Large', 'holmes' )          => 'large',
								esc_html__( 'Shop Single', 'holmes' )    => 'woocommerce_single',
								esc_html__( 'Shop Thumbnail', 'holmes' ) => 'woocommerce_thumbnail'
							),
							'save_always' => true
						),
						array(
							...
							'heading'    => esc_html__( 'Display Title', 'holmes' ),
							'value'      => array_flip( holmes_mkdf_get_yes_no_select_array( false, true ) ),
							'group'      => esc_html__( 'Product Info', 'holmes' )
						),
						//array(
						//	'type'       => 'dropdown',
						//	'param_name' => 'product_info_skin',
						//	'heading'    => esc_html__( 'Product Info Skin', 'holmes' ),
						//	'value'      => array(
						//		esc_html__( 'Default', 'holmes' ) => 'default',
						//		esc_html__( 'Light', 'holmes' )   => 'light',
						//		esc_html__( 'Dark', 'holmes' )    => 'dark'
						//	),
						//	'dependency' => array( 'element' => 'info_position', 'value' => array( 'info-on-image' ) ),
						//	'group'      => esc_html__( 'Product Info Style', 'holmes' )
						//),
						array(
							'type'       => 'dropdown',
						...
						//	'heading'    => esc_html__( 'Display Category', 'holmes' ),
						...
						//	'heading'    => esc_html__( 'Display Excerpt', 'holmes' ),
						//	'value'      => array_flip( holmes_mkdf_get_yes_no_select_array( false ) ),
						//	'group'      => esc_html__( 'Product Info', 'holmes' )
						//),
						//array(
						...
						//	'heading'     => esc_html__( 'Excerpt Length', 'holmes' ),
						//	'description' => esc_html__( 'Number of characters', 'holmes' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Display Rating', 'holmes' ),
							'value'      => array_flip( holmes_mkdf_get_yes_no_select_array( false, true ) ),
							'group'      => esc_html__( 'Product Info', 'holmes' )
						),
						array(
							...
							'heading'    => esc_html__( 'Display Price', 'holmes' ),
							'value'      => array_flip( holmes_mkdf_get_yes_no_select_array( false, true ) ),
							'group'      => esc_html__( 'Product Info', 'holmes' )
						),
						array(
							...
							'heading'    => esc_html__( 'Display Button', 'holmes' ),
							'value'      => array_flip( holmes_mkdf_get_yes_no_select_array( false, true ) ),
							'group'      => esc_html__( 'Product Info', 'holmes' )
						),
						//array(
						...
						//	'heading'    => esc_html__( 'Button Skin', 'holmes' ),
						//	'value'      => array(
						//		esc_html__( 'Default', 'holmes' ) => 'default',
						//		esc_html__( 'Light', 'holmes' )   => 'light',
						//		esc_html__( 'Dark', 'holmes' )    => 'dark'
						...
						//	'heading'    => esc_html__( 'Shader Background Color', 'holmes' ),
						//	'group'      => esc_html__( 'Product Info Style', 'holmes' )
						//),
						//array(
						//	'type'       => 'dropdown',
						//	'param_name' => 'info_bottom_text_align',
						//	'heading'    => esc_html__( 'Product Info Text Alignment', 'holmes' ),
						//	'value'      => array(
						//		esc_html__( 'Default', 'holmes' ) => '',
						...
						//	'heading'    => esc_html__( 'Product Info Bottom Margin (px)', 'holmes' ),
						//	'dependency' => array( 'element' => 'info_position', 'value'   => array( 'info-below-image' ) ),
						//	'group'      => esc_html__( 'Product Info Style', 'holmes' )
						//)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = holmes_mkdf_get_woo_shortcode_module_template_part( 'templates/product-list', 'product-list', $params['type'], $params, $additional_params );
	...
	public function getTextWrapperStyles( $params ) {
		...
		if ( $params['info_bottom_margin'] !== '' ) {
			$styles[] = 'margin-bottom: ' . holmes_mkdf_filter_px( $params['info_bottom_margin'] ) . 'px';
		}
