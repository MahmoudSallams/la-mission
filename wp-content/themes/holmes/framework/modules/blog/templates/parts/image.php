...
$blog_list_image_id  = ! empty( $image_meta ) && holmes_mkdf_blog_item_has_link() ? holmes_mkdf_get_attachment_id_from_url( $image_meta ) : '';
?>

<?php if ( $has_featured ) { ?>
	<div class="mkdf-post-image">
		<?php if ( holmes_mkdf_blog_item_has_link() ) { ?>
		...
		<?php } ?>
		<?php do_action('holmes_mkdf_action_blog_inside_image_tag')?>
	</div>
<?php } ?>