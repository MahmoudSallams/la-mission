<?php
$blog_single_navigation = holmes_mkdf_options()->getOptionValue('blog_single_navigation') === 'no' ? false : true;
$blog_navigation_through_same_category = holmes_mkdf_options()->getOptionValue('blog_navigation_through_same_category') === 'no' ? false : true;
?>
			...
			<?php
				...
				$post_navigation = array(
					'prev' => array(
						...
						'label' => '<span class="mkdf-blog-single-nav-label">'.esc_html__('previous', 'holmes').'</span>'
					),
					'next' => array(
						'mark' => '<span class="mkdf-blog-single-nav-mark ion-ios-arrow-thin-right"></span>',
						'label' => '<span class="mkdf-blog-single-nav-label">'.esc_html__('next', 'holmes').'</span>'
					)
				);
