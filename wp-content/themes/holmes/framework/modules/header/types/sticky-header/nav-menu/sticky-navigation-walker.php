...
if ( ! class_exists( 'HolmesMkdfStickyNavigationWalker' ) ) {
	class HolmesMkdfStickyNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( $item->hide == "" ) {
				...
				$subtitle = '';
				if ( $item->subtitle !== "" ) {
					$subtitle .= '<span class="mkdf-menu-subtitle">' . $item->subtitle . '</i>';
				}
				...
				$item_output .= $subtitle . $featured_icon;
