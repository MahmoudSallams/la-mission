		...
		switch ( $net ) {
			...
			case 'twitter':
				...
				if ( wp_is_mobile() ) {
					...
					$link = 'window.open(\'http://twitter.com/home?status=' . urlencode( holmes_mkdf_the_excerpt_max_charlength( $count_char ) . $twitter_via ) . get_permalink() . '\', \'popupwindow\', \'scrollbars=yes,width=800,height=400\');';
				}
				break;
			case 'google_plus':
