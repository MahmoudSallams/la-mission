...
function free_world_continent_map_plugin_view() {
    ?>
    <h2>Map Preview</h2>
<div style="padding: 10px; background: #fffde6; border-radius: 10px; border: 1px solid #e6e6ce; width:500px; margin-bottom:5px;">This plugin is deprecated. Please use our new <a href="<?php echo get_site_url();?>/wp-admin/plugin-install.php?s=html5maps&tab=search&type=author">Free HTML5 Maps</a> plugin instead.<br>It includes a responsive mobile-friendly map of the World.</div>
    ...
    ?>
        ...
        More <strong>free</strong> and <strong>premium</strong> interactive maps on the web site <a target="_blank" href="https://www.fla-shop.com">www.fla-shop.com</a><br />

	</div>
<div style="width:240px;float:left;padding-left:10px;"><a href="https://www.fla-shop.com/products/wp-plugins/world/countries/" target="_blank" rel="nofollow"><img src="<?php echo get_site_url();?>/wp-content/plugins/interactive-world-map/static/img/banner-premium-world-map.png" border="0"></a></div>
...
function free_world_map_plugin_license_link_show( $plugin_name ) {
    ...
    echo '</tr><tr class="plugin-update-tr"><td colspan="3" class="plugin-update"><div class="update-message" style="margin:5px;">This plugin is deprecated. Please use our new <a href="';
	echo get_site_url();
	echo '/wp-admin/plugin-install.php?s=html5maps&tab=search&type=author">Free HTML5 Maps</a> plugin instead. It includes a responsive mobile-friendly map of the World.</div></td>';
